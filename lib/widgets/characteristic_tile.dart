...
class _CharacteristicTileState extends State<CharacteristicTile> {
  ...
  Future onReadPressed() async {
    var data = _value;
    Uint8List data_X = Uint8List(0);
    data_X = Uint8List.fromList([...data_X, ...data]);
    var text = String.fromCharCodes(data_X);
    try {
      await c.read();
      Snackbar.show(ABC.c, "Read: Success $text", success: true);
    } catch (e) {
